...
◊entry{
 ...
 ◊summary{I published an article about using PLT Redex to play a game of Peg Solitaire. It is an amusing and gentle introduction to the tool used to build languages, without complicated formalism.}
}
