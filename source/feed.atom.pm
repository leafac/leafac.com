...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|music/my-first-robot}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|prose/email-migration}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|prose/programming-language-theory-explained-for-the-working-programmer--simple-interpreter}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|music/agora-ha-algo-a-temer}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|music/o-fim-da-tempestade}]
...
◊entry{
 ◊title{Criatividade}
 ◊link[#:href ◊~a{◊|base-url|music/criatividade}]
...
◊entry{
 ◊title{United}
 ◊link[#:href ◊~a{◊|base-url|music/united}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|prose/programming-language-theory-explained-for-the-working-programmer--principles-of-programming-languages}]
...
◊entry{
 ...
 ◊link[#:href ◊~a{◊|base-url|prose/playing-the-game-with-plt-redex}]
