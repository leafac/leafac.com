...
(require racket/string racket/format racket/list racket/match racket/file racket/system racket/port
         file/sha1
         libuuid gregor gregor/period xml txexpr
         pollen/core pollen/tag pollen/decode pollen/setup)

(provide (all-defined-out)
         (all-from-out
          racket/string racket/format racket/list racket/match racket/file racket/system racket/port
          file/sha1
          libuuid gregor gregor/period xml txexpr
          pollen/core pollen/tag pollen/decode pollen/setup))
...
(define settings/description ◊~a{Leandro Facchinetti writes prose, software and music. He is a Ph.D. candidate in Computer Science at the Programming Languages Laboratory, at the Johns Hopkins University, advised by Dr. Scott Smith. Beyond research, his interests are writing, computer programming, music, typography, education, minimalism and veganism.})
