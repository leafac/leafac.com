...
◊margin-note{Racket comes with ◊link["https://docs.racket-lang.org/reference/sets.html"]{functions for sets}, including ◊code{set} to create them, ◊code{set-empty?} to check their emptiness and so forth.}
